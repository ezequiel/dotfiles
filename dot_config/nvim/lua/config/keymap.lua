...
vim.keymap.set({ "n", "i", "x" }, "<Esc>", "<Esc><cmd>doautocmd FocusLost<CR><cmd>nohlsearch<CR>", { noremap = true })
...
vim.keymap.set("n", "<leader>d", vim.diagnostic.setqflist, { desc = "Open diagnostics in quickfix list" })
