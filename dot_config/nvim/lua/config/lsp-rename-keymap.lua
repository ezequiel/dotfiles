-- credit: https://github.com/fightingdreamer
-- https://github.com/neovim/neovim/discussions/24121#discussioncomment-9557420
...
vim.keymap.set("n", "<leader>rn", lsp_buf_rename_use_priority_or_select)
